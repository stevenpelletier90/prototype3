    ...
    <header>
        <div class="carousel slide" data-ride="carousel" id="carouselHome">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item active" style="background-image:url('images/conservation5.jpg');">
                   
                </div>
                <!-- Slide Two - Set the background image for this slide in the line below -->
                <div class="carousel-item" style="background-image: url('images/protecting1.jpg')">
                    
                </div>
                <!-- Slide Three - Set the background image for this slide in the line below -->
                <div class="carousel-item" style="background-image: url('images/spreading1.jpg')" alt="Header Image Turtle" title="Header Image Turtle">
