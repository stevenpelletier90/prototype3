...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-4 my-4 calendarinfo">
      <i aria-hidden="true" class="fa fa-5x fa-map-marker"></i>
      <p>6990 N. Ocean Blvd.<br>
      Boynton Beach, FL 33435</p>
    </div>
    <div class="col-sm-4 my-4 calendarinfo">
      <i aria-hidden="true" class="fa fa-5x fa-calendar"></i>
      <p>Last Saturday of Every Week<br>
      Rain or Shine</p>
    </div>
    <div class="col-sm-4 my-4 calendarinfo">
      <i aria-hidden="true" class="fa fa-5x fa-clock-o"></i>
      <p>8:00am - 10:30am<br>
      Holidays may effect time</p>
    </div>
  </div>
</div>
<hr class="pb-5">
